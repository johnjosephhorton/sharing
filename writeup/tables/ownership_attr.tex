...
\hline \\[-1.8ex] 
 Unpredictability index (UI) & 0.123^{***} &  & 0.090^{***} \\ 
  ...
  & (0.031) & (0.032) & (0.033) \\ 
 \hline \\[-1.8ex] 
Observations & \multicolumn{1}{c}{491} & \multicolumn{1}{c}{494} & \multicolumn{1}{c}{489} \\ 
Log Likelihood & \multicolumn{1}{c}{-343.392} & \multicolumn{1}{c}{-346.230} & \multicolumn{1}{c}{-342.063} \\ 
\hline 
\hline \\[-1.8ex] 
\end{tabular}
