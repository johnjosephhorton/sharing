...
In this region, the immediate possibility of mutually beneficial trade exists between the two types, whereas tin the other spaces a revision in the ownership decision is needed to support a P2P rental market. 
