...
%% flourish.
  Entrepreneurs have created a number of new Internet-based platforms where owners sometimes rent out their durable goods. 
  Airbnb and Uber are salient examples of these ``sharing economy'' platforms.
  We develop a model of these kinds of markets and analyze the
  determinants of ownership, rental rates, quantities, and the surplus generated in these markets. 
  Our analysis considers both a short run, before consumers can revise their ownership decisions and a long run, in which they can.
